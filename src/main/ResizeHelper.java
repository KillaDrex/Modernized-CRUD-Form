...
/**
 * From:https://stackoverflow.com/questions/19455059/allow-user-to-resize-an-undecorated-stage?noredirect=1&lq=1
 * Util class to handle window resizing when a stage style set to StageStyle.UNDECORATED.
 * Includes dragging of the stage.
 * Modified to set customizable min dimension limits.
 * Original on 6/13/14.
 * Updated on 8/15/17.
 * Updated on 12/19/19.
 * Updated on 5/13/2022.
 * Minor problems: Pressing and holding button allows dragging screen & some sides (e.g. W, NW) do not resize smoothly (as said by Zachary Perales on StackO).
 *
